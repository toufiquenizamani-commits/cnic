package com.decodex.bijlinazar;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void runTextRecognition(android.graphics.Bitmap bitmap) {
            ...
            .addOnFailureListener(new com.google.android.gms.tasks.OnFailureListener() {
                ...
                public void onFailure(Exception e) {
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            mWebView.evaluateJavascript("window.handleOcrError('OCR processing failed')", null);
                        }
                    });
                }
            });
    ...
    private void processTextBlock(com.google.mlkit.vision.text.Text visionText) {
        org.json.JSONArray linesJson = new org.json.JSONArray();
        for (com.google.mlkit.vision.text.Text.TextBlock block : visionText.getTextBlocks()) {
            for (com.google.mlkit.vision.text.Text.Line line : block.getLines()) {
                linesJson.put(line.getText());
            }
        }
        
        final String jsCommand = "window.handleOcrResult(" + linesJson.toString() + ")";
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
    ...
    /**
     * Native JavaScript Interface to bridge haptic vibration and Camera OCR scanner.
     */
    public static class AndroidBridge {
        ...
        AndroidBridge(MainActivity activity) {
            ...
            this.vibrator = (android.os.Vibrator) activity.getSystemService(android.content.Context.VIBRATOR_SERVICE);
        }
